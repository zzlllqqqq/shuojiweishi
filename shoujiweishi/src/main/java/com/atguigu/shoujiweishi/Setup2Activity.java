...
public class Setup2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String SNnumber = SPUtils.getInstance(this).getValue(SPUtils.SIM_NUMBER, null);
        if(SNnumber!=null) {
        ...
        cb_setup2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    cb_setup2.setText("已绑定SIM卡");
                    cb_setup2.setTextColor(Color.BLACK);
                    SPUtils.getInstance(Setup2Activity.this).save(SPUtils.SIM_NUMBER, number);
                } else {
                    cb_setup2.setText("没有绑定SIM卡");
                    cb_setup2.setTextColor(Color.RED);
                    SPUtils.getInstance(Setup2Activity.this).remove(SPUtils.SIM_NUMBER);
                }
            }
        });
    }
